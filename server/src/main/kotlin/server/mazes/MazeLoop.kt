...
class MazeLoop : Maze(UUID.fromString("a3f67367-c70a-45c2-8708-8e9df70a1954"), Position(10, 10), Player(1000)) {
    ...
    private fun addColumn02(infos: MutableList<PositionInfo>) {
        ...
        infos.add(
            PositionInfo(
                Position(2, 11), listOf(Direction.TOP, Direction.BOTTOM, Direction.LEFT, Direction.RIGHT), """
    ...
    private fun addColumn03(infos: MutableList<PositionInfo>) {
        ...
        infos.add(
            PositionInfo(
                Position(3, 9), listOf(Direction.LEFT, Direction.RIGHT), "",
        ...
        infos.add(
            PositionInfo(
                Position(3, 13), listOf(Direction.LEFT, Direction.RIGHT), "",
                offsets = mapOf(Direction.LEFT to MoveOffsetInfo(text = ONEWAY))
            )
        )
    ...
    private fun addColumn04(infos: MutableList<PositionInfo>) {
        infos.add(
            PositionInfo(
                Position(4, 7), listOf(Direction.TOP, Direction.LEFT), "",
                offsets = mapOf(Direction.LEFT to MoveOffsetInfo(text = ONEWAY))
            )
        )
        ...
        infos.add(
            PositionInfo(
                Position(4, 10), listOf(Direction.TOP, Direction.BOTTOM), "",
        ...
        infos.add(
            PositionInfo(
                Position(4, 12), listOf(Direction.TOP, Direction.BOTTOM), "",
        ...
        infos.add(
            PositionInfo(
                Position(4, 15), listOf(Direction.BOTTOM, Direction.LEFT), "",
                offsets = mapOf(Direction.LEFT to MoveOffsetInfo(text = ONEWAY))
            )
        )
    }
    ...
    private fun addColumn07(infos: MutableList<PositionInfo>) {
        ...
        infos.add(
            PositionInfo(
                Position(7, 5), listOf(Direction.TOP, Direction.BOTTOM), "",
                offsets = mapOf(Direction.BOTTOM to MoveOffsetInfo(text = ONEWAY))
            )
        )
        ...
        infos.add(
            PositionInfo(
                Position(7, 17), listOf(Direction.TOP, Direction.BOTTOM), "",
                offsets = mapOf(Direction.TOP to MoveOffsetInfo(text = ONEWAY))
            )
        )
    ...
    private fun addColumn08(infos: MutableList<PositionInfo>) {
        ...
        infos.add(
            PositionInfo(
                Position(8, 10), listOf(Direction.TOP, Direction.BOTTOM, Direction.RIGHT), "",
        ...
        infos.add(
            PositionInfo(
                Position(8, 12), listOf(Direction.TOP, Direction.BOTTOM, Direction.RIGHT), "",
    ...
    private fun addColumn09(infos: MutableList<PositionInfo>) {
        ...
        infos.add(
            PositionInfo(
                Position(9, 3), listOf(Direction.TOP, Direction.BOTTOM), "",
                offsets = mapOf(Direction.BOTTOM to MoveOffsetInfo(text = ONEWAY))
            )
        )
        ...
        infos.add(
            PositionInfo(
                Position(9, 19), listOf(Direction.TOP, Direction.BOTTOM), "",
                offsets = mapOf(Direction.TOP to MoveOffsetInfo(text = ONEWAY))
            )
        )
    ...
    private fun addColumn10(infos: MutableList<PositionInfo>) {
        ...
        infos.add(
            PositionInfo(
                Position(10, 4), listOf(Direction.LEFT, Direction.RIGHT), "",
                offsets = mapOf(Direction.RIGHT to MoveOffsetInfo(text = ONEWAY))
            )
        )
        infos.add(
            PositionInfo(
                Position(10, 8), listOf(Direction.TOP, Direction.LEFT, Direction.RIGHT), "",
        ...
        infos.add(
            PositionInfo(
                Position(10, 14), listOf(Direction.BOTTOM, Direction.LEFT, Direction.RIGHT), "",
                offsets = mapOf(Direction.RIGHT to MoveOffsetInfo(1, 0, BRIDGE))
            )
        ) // Brug naar rechts
        infos.add(
            PositionInfo(
                Position(10, 18), listOf(Direction.LEFT, Direction.RIGHT), "",
                offsets = mapOf(Direction.RIGHT to MoveOffsetInfo(text = ONEWAY))
            )
        )
    ...
    private fun addColumn11(infos: MutableList<PositionInfo>) {
        infos.add(
            PositionInfo(
                Position(11, 2), listOf(Direction.TOP, Direction.BOTTOM, Direction.LEFT, Direction.RIGHT), """
        ...
        infos.add(
            PositionInfo(
                Position(11, 20), listOf(Direction.TOP, Direction.BOTTOM, Direction.LEFT, Direction.RIGHT), """
    ...
    private fun addColumn12(infos: MutableList<PositionInfo>) {
        ...
        infos.add(
            PositionInfo(
                Position(12, 4), listOf(Direction.LEFT, Direction.RIGHT), "",
                offsets = mapOf(Direction.LEFT to MoveOffsetInfo(text = ONEWAY))
            )
        )
        infos.add(
            PositionInfo(
                Position(12, 8), listOf(Direction.TOP, Direction.LEFT, Direction.RIGHT), "",
        ...
        infos.add(
            PositionInfo(
                Position(12, 14), listOf(Direction.BOTTOM, Direction.LEFT, Direction.RIGHT), "",
                offsets = mapOf(Direction.LEFT to MoveOffsetInfo(-1, 0, BRIDGE))
            )
        ) // Brug naar links
        infos.add(
            PositionInfo(
                Position(12, 18), listOf(Direction.LEFT, Direction.RIGHT), "",
                offsets = mapOf(Direction.LEFT to MoveOffsetInfo(text = ONEWAY))
            )
        )
    ...
    private fun addColumn13(infos: MutableList<PositionInfo>) {
        ...
        infos.add(
            PositionInfo(
                Position(13, 3), listOf(Direction.TOP, Direction.BOTTOM), "",
                offsets = mapOf(Direction.BOTTOM to MoveOffsetInfo(text = ONEWAY))
            )
        )
        ...
        infos.add(
            PositionInfo(
                Position(13, 19), listOf(Direction.TOP, Direction.BOTTOM), "",
                offsets = mapOf(Direction.TOP to MoveOffsetInfo(text = ONEWAY))
            )
        )
    ...
    private fun addColumn14(infos: MutableList<PositionInfo>) {
        ...
        infos.add(
            PositionInfo(
                Position(14, 10), listOf(Direction.TOP, Direction.BOTTOM, Direction.LEFT), "",
                offsets = mapOf(Direction.TOP to MoveOffsetInfo(0, 1, BRIDGE))
            )
        ) // Brug naar boven
        ...
        infos.add(
            PositionInfo(
                Position(14, 12), listOf(Direction.TOP, Direction.BOTTOM, Direction.LEFT), "",
                offsets = mapOf(Direction.BOTTOM to MoveOffsetInfo(0, -1, BRIDGE))
            )
        ) // Brug naar beneden
    ...
    private fun addColumn15(infos: MutableList<PositionInfo>) {
        ...
        infos.add(
            PositionInfo(
                Position(15, 5), listOf(Direction.TOP, Direction.BOTTOM), "",
                offsets = mapOf(Direction.BOTTOM to MoveOffsetInfo(text = ONEWAY))
            )
        )
        ...
        infos.add(
            PositionInfo(
                Position(15, 17), listOf(Direction.TOP, Direction.BOTTOM), "",
                offsets = mapOf(Direction.TOP to MoveOffsetInfo(text = ONEWAY))
            )
        )
    ...
    private fun addColumn17(infos: MutableList<PositionInfo>) {
        infos.add(
            PositionInfo(
                Position(17, 7), listOf(Direction.LEFT, Direction.RIGHT), "",
                offsets = mapOf(Direction.RIGHT to MoveOffsetInfo(text = ONEWAY))
            )
        )
        ...
        infos.add(
            PositionInfo(
                Position(17, 15), listOf(Direction.LEFT, Direction.RIGHT), "",
                offsets = mapOf(Direction.RIGHT to MoveOffsetInfo(text = ONEWAY))
            )
        )
    }
    ...
    private fun addColumn18(infos: MutableList<PositionInfo>) {
        ...
        infos.add(
            PositionInfo(
                Position(18, 10), listOf(Direction.TOP, Direction.BOTTOM), "",
                offsets = mapOf(Direction.TOP to MoveOffsetInfo(text = ONEWAY))
            )
        )
        ...
        infos.add(
            PositionInfo(
                Position(18, 12), listOf(Direction.TOP, Direction.BOTTOM), "",
                offsets = mapOf(Direction.BOTTOM to MoveOffsetInfo(text = ONEWAY))
            )
        )
    ...
    private fun addColumn19(infos: MutableList<PositionInfo>) {
        ...
        infos.add(
            PositionInfo(
                Position(19, 9), listOf(Direction.LEFT, Direction.RIGHT), "",
                offsets = mapOf(Direction.RIGHT to MoveOffsetInfo(text = ONEWAY))
            )
        )
        ...
        infos.add(
            PositionInfo(
                Position(19, 13), listOf(Direction.LEFT, Direction.RIGHT), "",
                offsets = mapOf(Direction.RIGHT to MoveOffsetInfo(text = ONEWAY))
            )
        )
    ...
    private fun addColumn20(infos: MutableList<PositionInfo>) {
        ...
        infos.add(
            PositionInfo(
                Position(20, 11), listOf(Direction.TOP, Direction.BOTTOM, Direction.LEFT, Direction.RIGHT), """
